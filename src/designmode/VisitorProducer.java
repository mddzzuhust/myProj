...
class MaterialWin extends JFrame implements ItemListener
{
    ...
    Company1 visitor1,visitor2;    //访问者对象
    String[] select;
    MaterialWin()
    {
...
//具体访问者：艺术公司
class ArtCompany implements Company1
{
...
//具体访问者：造币公司
class Mint implements Company1
{
    public String create(Paper element)
    {
        return "纸币";
...
interface Material
{
    String accept(Company1 visitor);
}
//具体元素：纸
class Paper implements Material
{
    public String accept(Company1 visitor)
    {
