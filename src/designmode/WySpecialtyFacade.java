...
class Specialty1 extends ImageIcon
{
    ...
    Specialty1()
    {
        super("src/WyImage/Specialty11.jpg");
    }
}
class Specialty2 extends ImageIcon
{
    ...
    Specialty2()
    {
        super("src/WyImage/Specialty12.jpg");
    }
}
class Specialty3 extends ImageIcon
{
    ...
    Specialty3()
    {
        super("src/WyImage/Specialty13.jpg");
    }
}
class Specialty4 extends ImageIcon
{
    ...
    Specialty4()
    {
        super("src/WyImage/Specialty14.jpg");
    }
}
class Specialty5 extends ImageIcon
{
    ...
    Specialty5()
    {
        super("src/WyImage/Specialty21.jpg");
    }
}
class Specialty6 extends ImageIcon
{
    ...
    Specialty6()
    {
        super("src/WyImage/Specialty22.jpg");
    }
}
class Specialty7 extends ImageIcon
{
    ...
    Specialty7()
    {
        super("src/WyImage/Specialty23.jpg");
    }
}
class Specialty8 extends ImageIcon
{
    ...
    Specialty8()
    {
        super("src/WyImage/Specialty24.jpg");
    }
}