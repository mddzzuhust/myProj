...
//离开同步代码块后，将此时value的值赋给valueAfterSync
                ...
                System.out.println("in run() - see value=" + currValue +", but rumor has it that it changed!");
                System.out.println("in run() - valueAfterSync=" + valueAfterSync);
                break;
            }
        }
...
// missedIt = true;
        value = 50;
        System.out.println("in workMethod() - just set missedIt=" + missedIt);
